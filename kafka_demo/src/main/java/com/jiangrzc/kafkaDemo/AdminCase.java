package com.jiangrzc.kafkaDemo;
...
public class AdminCase {
    ...
    public void before(){
        ...
        props.put(CommonClientConfigs.BOOTSTRAP_SERVERS_CONFIG,"192.168.201.32:9092");
    ...
    public void createTopics(){
        NewTopic topic = new NewTopic("streams-plaintext-input",4, (short) 1);   //分区4，副本为1
    ...
    public void describeLogDirs() throws Exception{
        DescribeLogDirsResult result = adminClient.describeLogDirs(Arrays.asList(0));   //查询broker.id 为0 的节点
        System.out.println(result.all().get());
    }
